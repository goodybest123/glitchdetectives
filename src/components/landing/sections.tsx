...
import footerLogoUrl from "@/assets/GOODNESS GLITCH (1).png";
        ...
        <div>
          ...
          <div className="relative mt-10 rounded-3xl p-6 sm:p-7 border border-white/15 bg-white/5 backdrop-blur-md overflow-hidden">
            ...
            <p className="text-base sm:text-lg text-white/90 leading-relaxed">
              ...
              In a world where AI generates answers instantly, the most valuable skill is knowing
              how to evaluate, verify, and reason. Glitch Detectives builds that skill: one mission
              at a time.
            </p>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mt-12 items-start">
          <div>
            <p className="text-lg text-[var(--color-brand-blue)]/80 leading-relaxed">
              Getting the right answer is great, but knowing why it's right is even better. The most
              important skills you can learn are how to spot mistakes, fix them, and teach someone
              else how you figured it out.
            </p>
            <blockquote
            ...
            >
              "The child who can explain <strong>why</strong> an answer is wrong learns ten times
              more than the child who only finds the right one."
            </blockquote>
          </div>
    ...
    <section id="how-it-works" style={{ backgroundColor: BG_LIGHT }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-20 lg:py-28">
        ...
        <div className="relative grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div
            className="hidden lg:block absolute left-12 right-12 top-16 h-px bg-dashed"
            style={{ borderTop: `2px dashed ${BLUE}`, opacity: 0.15 }}
          />
          {steps.map((s) => (
            <div
              key={s.n}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-20 lg:py-28">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {visible.map((w) => {
            const Card = (
              <div
                className={`group relative rounded-3xl overflow-hidden border border-black/5 bg-[var(--color-bg-light)] hover:scale-[1.03] transition-transform shadow-sm ${!w.active ? "" : ""}`}
              >
          ...
          {cards.map((c, i) => (
            ...
            >
              <div
                ...
                style={{ background: i % 2 ? MINT : YELLOW }}
              >
                {i === 0 ? (
                  <Lightbulb className="w-5 h-5 text-[var(--color-brand-blue)]" />
                ) : i === 1 ? (
                  <MessageSquare className="w-5 h-5 text-[var(--color-brand-blue)]" />
                ) : (
                  <Search className="w-5 h-5 text-[var(--color-brand-blue)]" />
                )}
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-20 lg:py-28">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="mt-5 text-[var(--color-brand-blue)]/80 text-base sm:text-lg leading-relaxed">
            Children can still experience the full Glitch Detectives reasoning journey through calm,
            hands-on printable activities designed for families who prefer low-screen or screen-free
            learning.
          </p>
    ...
    <section style={{ backgroundColor: YELLOW }}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20 lg:py-28 text-center">
        ...
        <p className="mt-5 text-[var(--color-brand-blue)]/80 text-lg max-w-2xl mx-auto">
          Step into a world where children investigate, repair, and teach their way to mathematical
          mastery.
        </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 flex flex-col sm:flex-row gap-8 items-start sm:items-center justify-between">
        <Link to="/" className="group flex items-center" aria-label="Glitch Detectives home">
          <img
            ...
            height={680}
            loading="lazy"
            className="h-20 sm:h-24 w-auto object-contain transition-transform group-hover:scale-[1.03]"
          />
        </Link>
