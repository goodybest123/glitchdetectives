  ...
  return (
    <div className="rounded-3xl bg-white p-6 sm:p-10 shadow-[0_10px_40px_-12px_rgba(15,23,42,0.15)] ring-1 ring-neutral-100">
      <div className="mb-6 text-center">
        <div className="text-xs font-bold tracking-[0.2em] text-[#10b981]">CASE FILE 02</div>
        ...
        <div className="mt-2 flex items-center justify-center gap-2">
          <p className="text-sm text-neutral-500">Three number puzzles. Solve them in any order.</p>
          <SpeakButton
            text={`Choose a case to investigate. Three number puzzles. Solve them in any order.`}
          />
        </div>
      </div>
