    ...
    <div className="rounded-3xl bg-white p-6 sm:p-10 shadow-[0_10px_40px_-12px_rgba(15,23,42,0.15)] ring-1 ring-neutral-100">
      <div className="mb-6 text-center">
        ...
        <h2 className="mt-1 text-2xl sm:text-3xl font-bold tracking-tight text-neutral-900">
          Choose a mismatched puzzle
        </h2>
        <div className="mt-2 flex items-center justify-center gap-2"><p className="text-sm text-neutral-500">Three unlike-denominator puzzles. Solve them in any order.</p><SpeakButton text={`Choose a mismatched puzzle. Three unlike-denominator puzzles. Solve them in any order.`} /></div>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="text-[11px] font-bold tracking-wider text-neutral-400">
                CASE 06.{String(i + 1).padStart(2, "0")}
              </div>
