  ...
  return (
    <div className="rounded-3xl bg-white p-6 sm:p-10 shadow-[0_10px_40px_-12px_rgba(15,23,42,0.15)] ring-1 ring-neutral-100">
      <div className="mb-6 text-center">
        <div className="text-xs font-bold tracking-[0.2em] text-[#8b5cf6]">CASE FILE 03</div>
        ...
        <div className="mt-2 flex items-center justify-center gap-2">
          ...
          <SpeakButton
            text={`Choose a shape to investigate. Three equivalent-fraction puzzles. Solve them in any order.`}
          />
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="text-[11px] font-bold tracking-wider text-neutral-400">
                CASE 03.{String(i + 1).padStart(2, "0")}
              </div>
