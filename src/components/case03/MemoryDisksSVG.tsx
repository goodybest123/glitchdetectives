...
export function MemoryDisksSVG({ dividersVisible, spinKey = 0 }: VisualProps) {
  return (
...
function Disk({
  ...
  // Build filled pie path (starting at top, sweeping clockwise)
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <svg
        ...
        className={`h-[180px] w-[180px] ${spinKey > 0 ? "animate-[disk-spin_900ms_ease-in-out]" : ""}`}
      >
        <style>{`
          @keyframes disk-spin {
