...
export function CaseStepper({ stage }: { stage: Stage }) {
  const activeIndex = stage === "solved" ? STEPS.length : STEPS.findIndex((s) => s.id === stage);
  const current =
    stage === "solved"
  ...
  return (
    <div className="sticky top-0 z-20 -mx-3 -mt-3 bg-white px-3 pt-3 pb-1 shadow-sm sm:-mx-5 sm:-mt-5 sm:px-5 sm:pt-5">
