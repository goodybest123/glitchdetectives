...
export const MINI_PACKS: MiniPack[] = [
  ...
  },
  {
    ...
    blurb:
      "A simple 6-page homeschool math planner for parents who want to plan less and understand more.",
    badges: ["Planner", "6 Pages", "Printable"],
    pageCount: 6,
    samplePages: [1, 2, 3],
    coverPage: 1,
    imageExt: "png",
    description: [
      ...
      "Inside the 6-page printable planner, you'll get a weekly overview, a daily maths plan, a place to spot the glitch in an answer, prompts for finding maths in everyday life, and a reflective end-of-week review to help you decide what to do next.",
