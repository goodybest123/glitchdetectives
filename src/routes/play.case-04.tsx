/**
 * `/play/case-04` — The Scale Weigh-In (Comparing Fractions).
...
import { ComparatorSymbol } from "@/components/shared/ComparatorSymbol";
import { ComparatorToggle } from "@/components/shared/ComparatorToggle";
...
function CaseFourPage() {
  ...
  const { solved: solvedMap, markSolved } = useCaseProgress("case-04", SUB_CASE_ORDER);
