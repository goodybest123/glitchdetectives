...
function SubCaseRunner({
  ...
  }, [stage, atTarget, attempts, studentQuotes, c.wrongDenominator, c.correctDenominator, wrongVerdictCount]);
      ...
      <div className="workbook-sheet">
        <section>
          <div className="workbook-content">
            <WorkbookCaseTools caseNumber="005" title={c.title} zedClaim={c.bubbles.investigate} storageId={`case-05-${caseId}`} />
