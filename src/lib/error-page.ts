...
<html lang="en">
  <head>
    ...
    <style>
      body { font: 15px/1.5 "Plus Jakarta Sans", system-ui, -apple-system, sans-serif; background: #fafafa; color: #111; display: grid; place-items: center; min-height: 100vh; margin: 0; padding: 1.5rem; }
